    ...
    : IClassFixture<RabbitMqFixture>
{
    ...
    public async Task Send_and_subscribe_preserve_body_and_headers()
    {
        ...
        await using IMessagingProtocol transport = fixture.CreateTransport();
    ...
    public async Task Consumer_group_delivers_each_message_once()
    {
        ...
        await using var firstSubscription = await subscriber.SubscribeAsync("conformance.group", Handle, options);
        await using var secondSubscription = await subscriber.SubscribeAsync("conformance.group", Handle, options);
