    ...
    : IClassFixture<RabbitMqFixture>
{
    ...
    public async Task Consumer_group_delivers_each_message_once()
    {
        ...
        await using var firstSubscription = await transport.SubscribeAsync("conformance.group", Handle, options);
        await using var secondSubscription = await transport.SubscribeAsync("conformance.group", Handle, options);
